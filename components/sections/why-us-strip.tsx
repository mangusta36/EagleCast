  ...
  const pillars = [
    {
      ...
      description:
        "Air-cushioned CornerSpring™ technology absorbs severe impacts.",
    },
    {
      icon: Magnet,
      title: "N52 MagSafe Magnet Array",
      description:
        "1,200g magnetic holding force for wireless charging & accessories.",
    },
    {
      icon: Sparkles,
      title: "Premium Materials Only",
      description:
        "European Florentine leather and anti-yellowing Bayer polymers.",
    },
    {
      icon: RefreshCw,
      title: "30-Day Risk-Get Trial",
      description:
        "Full refund or instant exchange with free prepaid return label.",
    },
  ];
