...
const faqItems = [
  [
    "Can I try eaglecast before choosing a package?",
    "Yes. Request a free trial so support can confirm your app, internet connection, and preferred device before you choose a plan.",
  ],
  [
    "Which devices work with eaglecast IPTV?",
    "eaglecast supports common IPTV workflows for Smart TV, Android, Firestick-style devices, iOS, Windows, and compatible set-top boxes.",
  ],
  [
  ...
  [
    "Does eaglecast support 4K streaming?",
  ...
  [
    "Does eaglecast offer reseller options?",
    "Yes. eaglecast supports reseller-friendly workflows for onboarding, trials, renewals, and device guidance.",
  ],
] as const;
      ...
      <div className="site-container section-pad">
        <div className="max-w-3xl">
          ...
          <p className="mt-4 text-base leading-7 text-ink-muted sm:text-lg">
            Compare the available eaglecast packages, then use the free trial to
...
export function EaglecastAtGlanceSection() {
  const factItems = [
    ...
    [
      "Trial",
      "A free trial is available so viewers can test setup before choosing a package.",
    ],
    [
      "Support",
        ...
        <div className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:gap-16">
          <div className="max-w-2xl">
            ...
            <h2 className="mt-4 text-[clamp(2rem,4.5vw,3rem)] font-black leading-tight tracking-tight text-ink">
              A clear introduction to the eaglecast streaming service
            </h2>
            <p className="mt-4 text-base leading-7 text-ink-muted sm:text-lg">
              eaglecast is a subscription-based IPTV streaming service built for
              people who want live TV, sports, movies, series, and catch-up
              viewing in one place. Instead of relying on a cable box or
              satellite installation, eaglecast works through compatible apps
            ...
            <p className="mt-4 text-base leading-7 text-ink-muted">
              ...
              before purchase. That is why eaglecast puts the free trial, device
              guidance, and support conversation early in the process, so
              viewers can confirm how the service behaves on the screen they
              actually use.
            </p>
            <p className="mt-4 text-base leading-7 text-ink-muted">
              eaglecast also supports the broader workflows around the service,
              including login help, portal help, renewals, and reseller
            ...
            <div className="mt-6 flex flex-wrap gap-3 text-sm font-semibold">
              ...
              <Link
                ...
                className="text-brand transition-colors hover:text-brand-strong"
              >
                eaglecast customer support
              </Link>
              <Link
                href="/reseller"
                className="text-brand transition-colors hover:text-brand-strong"
              >
                eaglecast reseller options
              </Link>
              <Link
                href="/blog"
                className="text-brand transition-colors hover:text-brand-strong"
...
export function WhyEagleCastSection() {
  const reasons = [
    [
      ...
      "A free trial helps confirm your device, app, and connection before you pick a package.",
    ],
    [
      "Guided setup",
  ...
  return (
    <section className="bg-canvas">
      <div className="site-container section-pad">
        <div className="max-w-3xl">
          <p className="text-xs font-black uppercase tracking-[0.18em] text-brand-strong">
            Why viewers choose eaglecast
          </p>
          <h2 className="mt-4 text-[clamp(2rem,4.5vw,3.25rem)] font-black leading-tight tracking-tight text-ink">
            A better IPTV experience starts with a better setup
          </h2>
          <p className="mt-4 text-base leading-7 text-ink-muted sm:text-lg">
            eaglecast is designed around simple package choices, practical setup
            preparation, and guidance for common device families.
          </p>
          <p className="mt-4 text-base leading-7 text-ink-muted">
            That matters because a good IPTV experience depends on more than a
            plan name. eaglecast helps viewers connect the service to the right
            device, test playback in real conditions, and get answers about
            support, login, and trial steps before turning a trial into a longer
            subscription.
          </p>
        </div>
    ...
    <section id="services" className="bg-canvas-alt">
      <div className="site-container section-pad">
        <div className="max-w-3xl">
          ...
          <p className="mt-4 text-base leading-7 text-ink-muted sm:text-lg">
            eaglecast is meant to cover the core viewing patterns that matter
          ...
          <p className="mt-4 text-base leading-7 text-ink-muted">
            The better way to evaluate a service like eaglecast is to look at
    ...
    <section id="devices" className="bg-canvas">
      <div className="site-container section-pad grid items-center gap-12 lg:grid-cols-[0.92fr_1.08fr]">
        <div>
          ...
          <h2 className="mt-4 text-[clamp(2rem,4.5vw,3.25rem)] font-black leading-tight tracking-tight text-ink">
            Watch eaglecast on the devices you already use
          </h2>
          ...
          <p className="mt-4 max-w-xl text-base leading-7 text-ink-muted">
            eaglecast supports common IPTV workflows for Smart TV apps, Android
            devices, Firestick-style streaming hardware, iPhone and iPad,
            Windows computers, and compatible TV boxes. That means many viewers
            can start with the screen they already own instead of rebuilding
            their setup from scratch.
          </p>
          <p className="mt-4 max-w-xl text-base leading-7 text-ink-muted">
            ...
            before requesting an eaglecast trial.
          </p>
        ...
        <div className="relative overflow-hidden rounded-lg border border-line bg-panel shadow-card">
          <div className="relative aspect-[16/11]">
            <Image
              ...
              alt="eaglecast supported devices for IPTV streaming"
              fill
...
export function HowItWorksSection() {
  const steps = [
    ...
    [
      "02",
      "Test eaglecast with a free trial",
      ...
      <div className="site-container section-pad grid gap-10 lg:grid-cols-[0.82fr_1.18fr]">
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-5 text-base leading-8 text-ink-muted">
            <p>
              eaglecast works best when viewers begin with the device and room
              they actually use most. That keeps the trial grounded in real
            ...
            <p>
              After the first successful eaglecast session, keep a short note of
              the device, app, and connection type that worked well. That makes
              future support, renewals, and household setup changes much easier
              to manage.
            </p>
          </div>
        </div>
          ...
          <div className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-end">
            <div>
              ...
              <p className="mt-4 text-base leading-7 text-[#475569]">
                The eaglecast reseller flow is designed for people who need a
              ...
              <p className="mt-4 text-base leading-7 text-[#475569]">
                ...
                eaglecast more clearly, support customers more consistently, and
                reduce avoidable setup confusion from the start.
              </p>
    ...
    <section className="bg-canvas-alt">
      <div className="site-container section-pad">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <div className="max-w-2xl">
            <p className="text-xs font-black uppercase tracking-[0.18em] text-brand-strong">
              eaglecast Guides & Resources
            </p>
            <h2 className="mt-4 text-[clamp(2rem,4.5vw,3.25rem)] font-black leading-tight tracking-tight text-ink">
              Popular eaglecast setup guides
            </h2>
            <p className="mt-4 text-base leading-7 text-ink-muted">
              These guides answer the questions most viewers ask before or just
              after starting with eaglecast: what IPTV is, how it compares with
              cable, which devices are easiest to use, how to set up a Smart TV,
              and what to check when buffering interrupts playback. They are
              written to help with real viewing decisions, not just search
              terms.
            </p>
          </div>
          <Link
    ...
    <section id="faq" className="bg-canvas">
      <div className="site-container section-pad">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-4 text-base leading-7 text-ink-muted">
            This eaglecast FAQ covers the questions people usually ask while
            comparing the service, testing a free trial, setting up a device,
      ...
      <div className="site-container py-14">
        <div className="rounded-lg border border-line bg-panel p-6 text-center md:p-10">
          ...
          <h2 className="mx-auto mt-4 max-w-3xl text-3xl font-black tracking-tight text-ink sm:text-4xl">
            Ready to test eaglecast on your screen?
          </h2>
